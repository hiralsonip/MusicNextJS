    ...
    return (
        <div className='h-auto md:h-[40rem] w-full rounded-md flex flex-col items-center justify-center relative overflow-hidden mx-auto py-10 md:py-0'>
            ...
            <div className='p-4 relative z-10 w-full text-center'>
                ...
                <div className='mt-4'>
                    <Button borderRadius='1.75rem' className='cursor-pointer bg-white dark:bg-black text-black dark:text-white border-neutral-200 dark:border-slate-800'>Explore Courses</Button>
                </div>
            </div>
        </div>
    )
